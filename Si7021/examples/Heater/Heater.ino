...
void loop() {
  ...
  * 
  * Replace second parameter with heater setting 0x00 to 0x0F (0 to 15).
  * Do not exceed 0x04 if powered by arduino! 
  * Use external 3.3V power supply if exceeding 0x04!
  */
